...
(function () {
    ...
    `;
        ...
        connectedCallback() {
            const closeButtonClick = i(e('[data-close]', this.shadowRoot), 'click');
            const escKey = i(document.documentElement, 'keyup')
                .filter((event) => event.key == 'Escape');
            const outsideClick = i(document.documentElement, 'click')
                .filter(event => event.target.classList.contains('whitebox'));
            e$1(closeButtonClick, escKey, outsideClick).subscribe(() => {
